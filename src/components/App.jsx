...
const App = () => {
  ...
  let tweet= 'https://twitter.com/intent/tweet?hashtags=Frases&related=freecodecamp&text=' +
                        ...
                        <div className="quote-box" >
                            ...
                            <div className="buttons">
                                ...
                                <a
                                    ...
                                    id="tweet-quote"
                                    title="Twitea esta frase!"
                                    target="_top"
                                >
                                
                                   <img 
                                   style={{ width: "30px", marginTop: "-3px" }}
                                   src="https://res.cloudinary.com/djbaqvlnn/image/upload/v1638139352/FreecodeCamp/logotipo-social-de-twitter_fgss2b.png" alt=""/>
                                </a>
                                ...
                                <a
                                    ...
                                    className="button"
                                    id="tumblr-quote"
                                    title="Publica esta cita en tumblr!"
                                    rel= "noreferrer"
                                    target="_blank"
                                >
                                   <img 
